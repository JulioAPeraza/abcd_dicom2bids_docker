...
neurodocker generate docker \
            ...
            --run-bash 'git clone https://github.com/NBCLab/abcd_dicom2bids_docker.git /opt/abcd_dicom2bids_dockerimg8' \
            --entrypoint "/neurodocker/startup.sh python3 /opt/abcd_dicom2bids_dockerimg8/entrypoint.py"
